...
class bsub:
    def __init__(self):
        ...
        self.model = tf.keras.models.load_model('../models/BioSmart/128x128unet_acc_0.9560_loss_0.0516_val-acc_0.9558_val-loss_0.0523_1.02M_24-10-21-DB_UCB300_Epochs_10x1E-4_5x1E-5')
